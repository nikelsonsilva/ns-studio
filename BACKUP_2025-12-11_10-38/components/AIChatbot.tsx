        ...
        <div className="fixed bottom-6 right-6 w-[90vw] md:w-[380px] h-[500px] max-h-[80vh] bg-barber-950 border border-barber-800 rounded-2xl shadow-2xl flex flex-col z-50 overflow-hidden animate-fade-in">
          ...
          <div className="bg-barber-900 p-4 border-b border-barber-800 flex justify-between items-center shadow-md">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-white text-sm">NS Studio AI</h3>
            ...
            <button 
              ...
              className="text-gray-400 hover:text-white p-2 hover:bg-barber-800 rounded-lg transition-colors"
            >
              <Minimize2 size={18} />
            </button>
          </div>
          ...
          <div className="p-4 bg-barber-900 border-t border-barber-800">
            <div className="relative flex items-center">
               <input 
                 ...
                 className="w-full bg-barber-950 border border-barber-800 text-white rounded-xl pl-4 pr-12 py-3 text-sm focus:border-barber-gold outline-none shadow-inner transition-colors placeholder:text-gray-600"
                 disabled={isLoading}
               />
               <button 
                 onClick={handleSend}
                 disabled={!input.trim() || isLoading}
                 className="absolute right-2 p-2 bg-barber-gold text-black rounded-lg hover:bg-yellow-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:scale-105 active:scale-95"
               >
                 <Send size={16} />
               </button>
            </div>
