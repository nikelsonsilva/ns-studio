...
const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        ...
        danger: "bg-red-500/10 text-red-500 border border-red-500/50 hover:bg-red-500 hover:text-main",
        success: "bg-green-600 hover:bg-green-700 text-main shadow-lg shadow-green-900/20"
    };
