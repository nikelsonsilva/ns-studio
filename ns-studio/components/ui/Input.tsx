  ...
  return (
    <div className={`space-y-1 ${containerClassName}`}>
      ...
      <div className="relative group">
        {icon && (
          <div className="absolute left-3 top-1/2 -translate-y-1/2 text-muted group-focus-within:text-barber-gold transition-colors duration-200 pointer-events-none">
            {icon}
          </div>
        )}
        <input 
